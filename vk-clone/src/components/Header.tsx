import { BellIcon, ChevronDownIcon, MagnifyingGlassIcon, MusicalNoteIcon } from '@heroicons/react/24/outline'
            ...
            <ul className='flex px-4 relative m-auto max-w-[1130px] items-center h-full'>
                ...
                <li className='flex items-center h-full'>
                    <div className='p-3 hover:bg-gray-100 cursor-pointer'>
                        <BellIcon height={24} width={24} color='grey' />
                    </div>
                </li>
                {/*Music */}
                    ...
                    <div className='p-2.5 hover:bg-gray-100 cursor-pointer'>
                        <Link href="/" className='flex items-center'>
                            <Image src="/profile-img.png"
                                ...
                                alt="profile-img" />
                            <ChevronDownIcon width={12} height={8} className='mx-1.5' />
                        </Link>
                    </div>
                </li>
            </ul>
